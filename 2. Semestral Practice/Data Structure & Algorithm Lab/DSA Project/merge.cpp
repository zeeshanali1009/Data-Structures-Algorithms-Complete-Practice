...
void splitList(Vehicle* source, Vehicle** front, Vehicle** back) {
...
Vehicle* mergeSortedLists(Vehicle* a, Vehicle* b) {
    if (a == NULL) {
        return b;
    }
